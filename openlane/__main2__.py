...
def run(
    ...
    try:
        ...
        TargetFlow: Optional[Type[Flow]] = Flow.factory.get("Demo")
        ...
        for config_file in config_files:
            if meta := GenIEConfig.get_meta(config_file):
                ...
                if meta.substituting_steps is not None and issubclass(TargetFlow, SequentialFlow):
