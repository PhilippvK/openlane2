...
from ..config import Config, AnyConfigs
from ..config import universal_flow_config_variables2
...
# class SequentialFlow2(SequentialFlow):
#     """
#     TODO.
#     """
#
...
#             # nonlocal step_ids
#             dangerous_fuzzy_matching = False
...
class SequentialFlow2(Flow):
    ...
    def get_all_config_variables(self) -> List[Variable]:
        ...
        flow_variables_by_name: Dict[str, Tuple[Variable, str]] = {
            ...
            for variable in universal_flow_config_variables2
        }
    ...
    @classmethod
    def Substitute(Self, Substitutions: Dict[str, Substitution]) -> Type[SequentialFlow]:
        """
